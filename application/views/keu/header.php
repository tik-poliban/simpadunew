    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="<?php cek_aktif($page,'home');?>">
          <a href="<?php echo base_url('keu');?>">
            <i class="fa fa-dashboard"></i> <span>Dashboard</span>
          </a>
		<li class="<?php cek_aktif($page,'surat_masuk');?>">
          <a href="<?php echo base_url('keu/surat_masuk');?>">
            <i class="fa fa-list-alt"></i> <span>Surat Masuk</span>
          </a>
        </li>
		<li class="<?php cek_aktif($page,'surat_tugas');?>">
          <a href="<?php echo base_url('keu/surat_tugas');?>">
            <i class="fa fa-list-alt"></i> <span>Surat Tugas</span>
          </a>
        </li>
		<li class="<?php cek_aktif($page,'proses_jaldis');?>">
          <a href="<?php echo base_url('keu/proses_jaldis');?>">
            <i class="fa fa-list-alt"></i> <span>Proses Perjalan Dinas</span>
          </a>
        </li>
