  ...
  <footer class="main-footer">
    <div class="pull-right hidden-xs">
      <b>Simpadu 2019</b> 2.0 | adminLTE2
    </div>
    Simpadu Ver.2 <strong>Copyright &copy; 2019,</strong> <small class="text-muted">AgusSBN, Arifin, Ronny F, Arif, Khair</small> 
...
<!-- SweetArlert -->
<script src="<?php echo base_url();?>assets/builds/sweetalert.min.js"></script>
