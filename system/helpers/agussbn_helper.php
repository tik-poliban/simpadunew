<?php
function input_text($nm_var,$caption,$place,$val=NULL,$ro=NULL){
?>  
...
function input_pd($nm_var,$caption,$isipd,$def){
?>  
  <div class="form-group">
    <label for="id_golongan_darah" class="col-sm-3 control-label"><?php echo $caption; ?></label>
    <div class="col-sm-8">
